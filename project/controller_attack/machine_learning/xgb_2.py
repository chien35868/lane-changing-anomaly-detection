...
anomaly_blocked_df = pd.read_csv('../trajectory/ghost_vehicle_attack_small/with_attack/anomaly_blocked_attack.csv')
...
normal_blocked_df = pd.read_csv('../trajectory/ghost_vehicle_attack_small/with_attack/normal_blocked_attack.csv')
...
print("xgb accuracy:", accuracy_score(y, y_pred))
print("xgb f1 score:", f1_score(y, y_pred, average='macro'))
tn, fp, fn, tp = confusion_matrix(y, y_pred).ravel()
print("tn: ", tn, "fp: ", fp, "fn: ", fn, "tp: " , tp, "\n")

print(len(y_pred), len(y_pred_true)) 
print("xgb accuracy:", accuracy_score(y_true, y_pred_true))
print("xgb f1 score:", f1_score(y_true, y_pred_true, average='macro'))
