...
sumoCmd = [sumoBinary, "-c", "controller_highway_speedlimit.sumocfg", "--step-length", f'{step_length}', "--seed", "62",  "--time-to-teleport", "8" ]


traci.start(sumoCmd)


f = open('./trajectory/ramp/ghost_vehicle_attack/without_attack/raw_trajectory.csv', 'w+')# modify
writer = csv.writer(f)
