...
int main(){
    ...
    for(int time=0 ; time<400; time++){ //200 time steps
        acceleration[time] = magnitude * sin(frequency * 0.1 * time);
    }
    for(int time=0; time<400; time++){ //200 time steps
...
// {   
//     FILE *file;
//     file = fopen("/home/r10922a06/Desktop/sumo2/sumo/project/controller_attack/trajectory/roundabout_6/ghost_vehicle_attack/without_attack/raw_trajectory.csv", "r");
//     char line[100];
//     char* element;
