...
/// @date    Fri, 08.10.2022
///
// A lane change model developed by D. Krajzewicz, J. Erdmann et al. between 2004 and 2022
/****************************************************************************/
#pragma once
#include <config.h>
 ...
 * et al. between 2004 and 2022
 */
class MSLCM_LC2022 : public MSAbstractLaneChangeModel {
public:

    MSLCM_LC2022(MSVehicle& v);

    virtual ~MSLCM_LC2022();

    /// @brief Returns the model's id
    LaneChangeModel getModelID() const override {
        return LaneChangeModel::LC2022;
    }
