...
SUMOVehicleParserHelper::parseLCParams(SUMOVTypeParameter* into, LaneChangeModel model, const SUMOSAXAttributes& attrs) {
    if (allowedLCModelAttrs.size() == 0) {
        ...
        std::set<SumoXMLAttr> lc2022Params;
        lc2022Params.insert(SUMO_ATTR_LCA_STRATEGIC_PARAM);
        lc2022Params.insert(SUMO_ATTR_LCA_COOPERATIVE_PARAM);
        lc2022Params.insert(SUMO_ATTR_LCA_SPEEDGAIN_PARAM);
        lc2022Params.insert(SUMO_ATTR_LCA_KEEPRIGHT_PARAM);
        lc2022Params.insert(SUMO_ATTR_LCA_OPPOSITE_PARAM);
        lc2022Params.insert(SUMO_ATTR_LCA_LOOKAHEADLEFT);
        lc2022Params.insert(SUMO_ATTR_LCA_SPEEDGAINRIGHT);
        lc2022Params.insert(SUMO_ATTR_LCA_MAXSPEEDLATSTANDING);
        lc2022Params.insert(SUMO_ATTR_LCA_MAXSPEEDLATFACTOR);
        lc2022Params.insert(SUMO_ATTR_LCA_MAXDISTLATSTANDING);
        lc2022Params.insert(SUMO_ATTR_LCA_ASSERTIVE);
        lc2022Params.insert(SUMO_ATTR_LCA_SPEEDGAIN_LOOKAHEAD);
        lc2022Params.insert(SUMO_ATTR_LCA_COOPERATIVE_ROUNDABOUT);
        lc2022Params.insert(SUMO_ATTR_LCA_COOPERATIVE_SPEED);
        lc2022Params.insert(SUMO_ATTR_LCA_OVERTAKE_RIGHT);
        lc2022Params.insert(SUMO_ATTR_LCA_SIGMA);
        lc2022Params.insert(SUMO_ATTR_LCA_KEEPRIGHT_ACCEPTANCE_TIME);
        lc2022Params.insert(SUMO_ATTR_LCA_OVERTAKE_DELTASPEED_FACTOR);
        lc2022Params.insert(SUMO_ATTR_LCA_EXPERIMENTAL1);
        allowedLCModelAttrs[LaneChangeModel::LC2022] = lc2022Params;
